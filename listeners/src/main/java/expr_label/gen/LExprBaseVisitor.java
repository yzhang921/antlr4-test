...
public class LExprBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements LExprVisitor<T> {
     ...
     */
    @Override
    public T visitS(LExprParser.SContext ctx) {
     ...
     */
    @Override
    public T visitAdd(LExprParser.AddContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitMult(LExprParser.MultContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitInt(LExprParser.IntContext ctx) {
        return visitChildren(ctx);
    }
}